...
import com.authentification.entity.DefaultExceptionMessageDto;
...
public class ExceptionMessageHandler {
    ...
    public ResponseEntity<ResponseWrapper> serviceException(ServiceException se) {
        ...
        return new ResponseEntity<>(
                ResponseWrapper.builder().success(false)
                        .code(HttpStatus.CONFLICT.value()).message(message).build(),
                HttpStatus.CONFLICT);
    }
    ...
    private Optional<DefaultExceptionMessageDto> getMessageFromAnnotation(Method method) {
        com.authentification.annotation.DefaultExceptionMessage defaultExceptionMessage = method.getAnnotation(com.authentification.annotation.DefaultExceptionMessage.class);

...
//    }
    ...
    public void anyPostOperations() {}

    @Pointcut("@annotation(org.springframework.web.bind.annotation.PutMapping)")
    public void anyPutOperations() {}

    @Around("anyPostOperations()")
    public Object anyPostOperationsAdvise(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        logger.warn("Before - Post Around -> Method:{} - Results:{}",
        ...
        logger.warn("After - Post Around -> Method:{} - Results:{}",

...
public class DataGenerator implements CommandLineRunner {
    ...
    Account a1 = new Account("Josie D Story", "262  Lochmere Lane", "United States", "Kentucky", "LOUISVILLE", 35, "40289", Roles.User);
    Account a2 = new Account("Bernard P Fendley", "2903  Jarvis Street", "United States", "New York", "Buffalo", 28, "14211", Roles.User);
    Account a3 = new Account("Faith R Parsons", "4161  Alfred Drive", "United States", "New York", "Brooklyn", 47, "11226", Roles.User);
    Account a4 = new Account("Johnnie J Cannon", "2587  Logan Lane", "United States", "New York", "HOLTSVILLE", 47, "00544", Roles.User);
    Account a5 = new Account("Lawrence E Folkerts", "698  Clark Street", "United States", "New York", "Brentwood", 47, "11717", Roles.User);
    ...
    //    LocalDateTime localDateTime, int rowNumber, int seatNumber
    ...
    private void createMoviesAndGenres() {
        ...
        m1.setGenreSet(Arrays.asList(g3, g1, g8));
        m2.setGenreSet(Arrays.asList(g13, g6));
        m3.setGenreSet(Arrays.asList(g6));
        m4.setGenreSet(Arrays.asList(g6, g8));
        m5.setGenreSet(Arrays.asList(g2, g3));
        m6.setGenreSet(Arrays.asList(g1));
        m7.setGenreSet(Arrays.asList(g4));
        m8.setGenreSet(Arrays.asList(g3, g8, g10));
        m9.setGenreSet(Arrays.asList(g3, g10));

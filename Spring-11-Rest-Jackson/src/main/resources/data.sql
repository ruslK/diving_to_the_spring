...
VALUES ('Hall 1 - EMPIRE', 'McDonald', (SELECT l.id from location l WHERE l.name = 'AMC Empire 25')),
       ...
       ('Hall 2 - SQUARE 13', 'Sony Corporation',
        (SELECT l.id from location l WHERE l.name = 'AMC Lincoln Square 13')),
...
VALUES ((SELECT m.id from movie m WHERE m.name = 'The Gentleman'),
...
INSERT INTO movie_cinema (local_date_time, cinema_id, movie_id)
...
INSERT INTO ticket (local_date_time, row_number, seat_number, movie_cinema_id, user_account_id)
